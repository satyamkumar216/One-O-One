  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      if (window.matchMedia('(prefers-reduced-motion: reduce)').matches) {
        gsap.set('.entrance-title-line', { opacity: 1, y: 0 });
        gsap.set('.timeline-node', { opacity: 1, x: 0 });
        ...
        <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 md:px-12 grid grid-cols-1 md:grid-cols-[4fr_6fr] gap-6 md:gap-12 items-center h-full max-h-[850px]">
          ...
          <div className="flex flex-col space-y-4 md:space-y-8">
            <div className="space-y-2 md:space-y-3">
              <span className="entrance-title-line block text-[11px] font-semibold tracking-[0.12em] text-brand-violet uppercase opacity-0">
                Workflow
              </span>
