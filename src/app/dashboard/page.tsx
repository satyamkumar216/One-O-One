...
export default function Dashboard() {
  ...
  if (!session) {
    return (
      <div className="min-h-screen bg-[#030303] flex items-center justify-center px-6 relative overflow-hidden">
        {/* Ambient Glows */}
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] rounded-full bg-brand-blue/5 blur-[120px] pointer-events-none" />
        <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] rounded-full bg-brand-violet/5 blur-[120px] pointer-events-none" />
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="flex flex-col space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-white/[0.04] border border-white/10 rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-brand-blue transition-colors"
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl bg-gradient-to-r from-brand-blue to-brand-violet text-white font-semibold text-xs tracking-widest uppercase hover:brightness-110 transition-all duration-300 disabled:opacity-50"
            >
  ...
  return (
    <div className="min-h-screen bg-[#030303] text-white p-6 sm:p-12 relative overflow-hidden">
      {/* Glows */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] rounded-full bg-brand-violet/5 blur-[150px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] rounded-full bg-brand-blue/5 blur-[150px] pointer-events-none" />
            ...
            <div className="space-y-4">
              {enquiries.map((enq) => (
                ...
                >
                  ...
                  {/* Email */}
                  <div className="lg:col-span-2 text-brand-blue font-medium mb-1 lg:mb-0 break-all select-all">
                    {enq.email}
                  </div>
